						...
						<div class="page-wrapper">
							...
							<div class="row">
									<div class="dt-buttons btn-overlap btn-group">
										<div class="p-2">
											<a flag="info"
										   class="dt-button buttons-colvis btn btn-white btn-primary1 btn-bold" data-toggle="tooltip"
										...
										<div class="p-2">
											<button id="btndelete" type="button" class="dt-button buttons-htm15 btn btn-white btn-primary1 btn-bold" data-toggle="tooltip" title="Xóa User">
												<span>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="btn btn-sm btn-primary1 btn-edit" data-toggle="tooltip"
                                                            title="Edit" href='${editURL}'><i
                                                                class="fa fa-pencil-square-o" style=" margin-right: 0;"
                                                                aria-hidden="true"></i>
                                                        </a>
                                                    </td>
                                                </tr>
									...
									<div class="card user-card">
										...
										<div class="card-body  text-center">
											<div class="usre-image">
												<img src="assets1/images/widget/img-round1.jpg" class="img-radius wid-100 m-auto" alt="User-Profile-Image">
											</div>
