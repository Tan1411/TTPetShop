                            ...
                            <tbody>
                                ...
                                <tr class="product_data">
                                        ...
                                        <td class="shoping__cart__item align-middle">
                                            <div ><img class="full-div-100px" src="data:image/jpeg;base64,${dtC.pro.base64Image}" alt="${dtC.pro.name}">
                                            <h5>${dtC.pro.name}</h5></div>
                                        </td>
                                        <td  class="shoping__cart__price align-middle">
                                            ${dtC.pro.formatPriceString}
                                        </td>
                                        <td id="price_item${dtC.productID}" style="display:none;">${dtC.pro.price}</td>
                ...
                <div id="totalHere">
                    <div class="shoping__checkout">
                        ...
                        <ul>
                            ...
                            <li>Total <span id="here">${USERMODEL.cartID.formatPriceString}</span></li>
                        </ul>
