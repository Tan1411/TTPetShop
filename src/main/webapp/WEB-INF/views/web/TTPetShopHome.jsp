...
<body>
                ...
                <div class="col-lg-12">
                    <div class="hero__item set-bg">
                        <div class="owl-carousel owl-1">
                            <div><img src="assetsWEB/slider/images/slider1.png" alt="Image" class="img-fluid"></div>
                            <div><img src="assetsWEB/slider/images/slider2.png" alt="Image" class="img-fluid"></div>
                            <div><img src="assetsWEB/slider/images/slider3.png" alt="Image" class="img-fluid"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
                    ...
                    <div class="featured__controls">
                        <ul>
                            ...
                            <c:forEach items="${Categories}" var="ct">
                                <li data-filter=".${ct.categoryID}">${ct.nameCat}</li>
                            </c:forEach>
            ...
            <div class="row featured__filter">
                <!-- <c:forEach begin="1" end="12" var="i">
                    <div class="col-lg-3 col-md-4 col-sm-6 mix Thời trang cho thú cưng">
                ...
                <c:forEach items="${proList}" var="us">
                    <div class=" product_data col-lg-3 col-md-4 col-sm-6 mix ${us.categoryID}">
                        <input type="hidden" class="productID" value="${us.productID}" />
                        <div class="featured__item">
                            <div class="featured__item__pic set-bg"
                                data-setbg="data:image/jpeg;base64,${us.base64Image}">
                                <ul class="featured__item__pic__hover">
                                    <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                    <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                    <li><button class="addtoCart"><a><i class="fa fa-shopping-cart"></i></a></button>
                                    </li>
                                </ul>
                            </div>
                            <div class="featured__item__text">
    ...
    <script type="text/javascript">
        ...
        //     //e.preventDefault();
        //     var proID= $(btn).closest('.product_data').find('.productID').val();
        //     alert(proID);
        // }
        // $('.addtoCart').click(function(e){
        //     e.preventDefault();
        //     var proID= $(this).closest('.product_data').find('.productID').val();
        //     //alert(proID);
        //     $ajax({
