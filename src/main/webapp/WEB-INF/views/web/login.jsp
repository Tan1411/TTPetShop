					...
					<div class="card-body">
						<form action="" class="login100-form validate-form" method="POST">
							...
							<div class="input-group mb-2">
								...
								<input type="text" class="form-control" placeholder="Username" name="username" maxlength="20">
							</div>
							...
							<!-- <input type="hidden" value="login" name="action" maxlength="50"/>-->
