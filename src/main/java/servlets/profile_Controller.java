...
//		    	String fullname= new String(request.getParameter("fullname").getBytes("ISO-8859-1"), "UTF-8").replaceAll("[^A-Za-z0-9@._/,]","");
//		    	String Email= request.getParameter("Email").replaceAll("[^A-Za-z0-9@._/,]","");
//		    	String password= request.getParameter("password").replaceAll("[^A-Za-z0-9@._/,]","");
//		    	String address= new String(request.getParameter("address").getBytes("ISO-8859-1"), "UTF-8").replaceAll("[^A-Za-z0-9@._/,]","");
//		    	String phone= request.getParameter("phone").replaceAll("[^A-Za-z0-9@._/,]","");
